...
void procTypedImageData(int sd, const char *name, const mxArray *imField, const mxArray *trField, DATATYPE dtype);
...
int procImageData(int sd, const char *name, const mxArray *ptr)
{
    ...
    case mxINT8_CLASS:
    {
        igtlInt8 dummy = igtl::ImageMessage::TYPE_INT8;
        procTypedImageData(sd, name, imageField, transField, dummy);
        break;
    }
    case mxUINT8_CLASS:
    {
        igtlUint8 dummy = igtl::ImageMessage::TYPE_UINT8;
        procTypedImageData(sd, name, imageField, transField, dummy);
        break;
    }
    case mxINT16_CLASS:
    {
        igtlInt16 dummy = igtl::ImageMessage::TYPE_INT16;
        procTypedImageData(sd, name, imageField, transField, dummy);
        break;
    }
    case mxUINT16_CLASS:
    {
        igtlUint16 dummy = igtl::ImageMessage::TYPE_UINT16;
        procTypedImageData(sd, name, imageField, transField, dummy);
        break;
    }
    case mxINT32_CLASS:
    {
        igtlInt32 dummy = igtl::ImageMessage::TYPE_INT32;
        procTypedImageData(sd, name, imageField, transField, dummy);
        break;
    }
    case mxUINT32_CLASS:
    {
        igtlUint32 dummy = igtl::ImageMessage::TYPE_UINT32;
        procTypedImageData(sd, name, imageField, transField, dummy);
        break;
    }
    case mxSINGLE_CLASS:
    {
        igtlFloat32 dummy = igtl::ImageMessage::TYPE_FLOAT32;
        procTypedImageData(sd, name, imageField, transField, dummy);
        break;
    }
    case mxDOUBLE_CLASS:
    {
        igtlFloat64 dummy = igtl::ImageMessage::TYPE_FLOAT64;
        procTypedImageData(sd, name, imageField, transField, dummy);
        break;
    }
    default:
